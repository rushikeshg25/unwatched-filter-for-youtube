...
WHAT IT NEEDS
You need to be signed in with watch history enabled — that is where the progress bars come from. If nothing on the page is marked as watched, the extension says so rather than silently showing you everything.
